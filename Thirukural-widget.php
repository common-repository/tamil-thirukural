...
class Thirukural_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="row">
			<div class="col-md-6">
				<p <?php echo "style=\"font-size: ".$explanation_font_size ?>";\">
					<?php echo $kural->chapter_name ?>
				</p>
			</div>
			<div class="col-md-6 text-right">
				<p <?php echo "style=\"font-size: ".$explanation_font_size ?>";\">
					<?php echo $kural->section_name ?>
				</p>
			</div>
		</div>
		<?php } ?>
		<div class="row kural-wrapper" <?php echo " style=\"font-size: ".$kural_font_size."; font-weight: ". $kural_bold ."; font-style:".$kural_italics.";\">" ?>
			<div class="col-md-12 kural"><?php echo $kural->kural ?></div>
		...
		<div class="row kural-explanation-wrapper">
			<div class="col-md-12">
				...
				<div class="kural-explanation" <?php echo "style=\"font-size: ".$explanation_font_size."; font-weight: ". $explanation_bold ."; font-style:".$explanation_italics."; \">". $explanation?></div>
			</div>
		</div>
		<?php }
		echo $after_widget;
...
add_action( 'widgets_init', function() { register_widget( 'Thirukural_Widget' ); } );
